...
type WithoutStringRef<P> = P extends { ref?: infer R }
  ? Omit<P, "ref"> & { ref?: Exclude<R, string> }
  : P;
...
interface SortableItemProps extends WithoutStringRef<React.ComponentProps<"div">> {
...
interface SortableItemHandleProps extends WithoutStringRef<React.ComponentProps<"button">> {
  asChild?: boolean;
}
